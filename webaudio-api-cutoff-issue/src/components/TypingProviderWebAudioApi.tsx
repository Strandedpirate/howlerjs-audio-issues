...
const soundType1 = new Howl({ src: [type1], preload: true });
const soundType2 = new Howl({ src: [type2], preload: true });
const soundType3 = new Howl({ src: [type3], preload: true });
...
const TypingProviderWebAudioApi = ({ children }: Props) => {
...
export default TypingProviderWebAudioApi;
